...
function TableProductosActive() {
    ...
    const [modal_204, setModal_204] = useState(false);
    const toggle_204 = () => setModal_204(!modal_204);
        ...
        <div className="scrolling-wrapper">
            <div className="cont-table-prod">
                <table className="table-cont-prod">
                    <thead>
                    <tr className="tr-head-prod-activo">
                    ...
                    <tr className="tr-body-prod">
                        <td className="td-body-prod">
                            <button type="button" onClick={() => toggle_204()} className="btn btn-color-principal"><span className="icon-boton"><ion-icon name="create-outline"></ion-icon></span>Editar</button>
                        </td>
                        <td className="td-body-prod">
                ...
                <Modal isOpen={modal_204} toggle={toggle_204} className="prod-modal">
                    <ModalHeader toggle={toggle_204}>
...
export default TableProductosActive;