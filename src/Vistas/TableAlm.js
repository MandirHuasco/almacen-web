...
function TableAlmacen() {
    ...
    const [modal_201, setModal_201] = useState(false);
    const toggle_201 = () => setModal_201(!modal_201);
    ...
    return(
        <div className="scrolling-wrapper">
            <div className="cont-table-prod">
                <table className="table-cont-prod">
                    ...
                    <tr className="tr-body-prod">
                        <td className="td-body-prod">
                            <button type="button" onClick={() => toggle_201()} className="btn btn-color-principal"><span className="icon-boton"><ion-icon name="repeat-outline"></ion-icon></span>Transferencia</button>
                        </td>
                ...
                <Modal isOpen={modal_201} toggle={toggle_201}>
                    <ModalHeader toggle={toggle_201}>
